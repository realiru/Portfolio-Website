  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event) => {
      ...
      if (window.innerWidth > 960) {
        ...
        faceTranslateX = Math.max(
          -maxTranslate,
          Math.min(maxTranslate, faceTranslateX),
        );
        faceTranslateY = Math.max(-maxTranslate, Math.min(0, faceTranslateY));

        let faceRotate =
          (Math.atan2(event.clientY - svgCenterY, event.clientX - svgCenterX) *
            (180 / Math.PI)) /
          10;
        const maxRotate = 3;
        ...
        faceGroup.setAttribute(
          "transform",
          `translate(${faceTranslateX}, ${faceTranslateY}) rotate(${faceRotate}, ${noseX}, ${noseY})`,
        );
      }
    };
        ...
        <Link to="/" className="navbar-logo" onClick={closeMobileMenu}>
          ...
          >
            ...
            <g id="face-group">
              {/* L Ear/R Ear */}
              <path
                d="M17.18 23.91c-6.9 0-12.5 5.6-12.5 12.5s5.6 12.5 12.5 12.5"
                style={{ fill: "#a25f32" }}
              />
              <path
                d="M80.77 48.91c6.9 0 12.5-5.6 12.5-12.5s-5.6-12.5-12.5-12.5"
                style={{ fill: "#5a3316" }}
              />

              {/* L Cheek/R Cheek */}
              <path
                d="M48.98 74.53c-14.88.37-28.91-9.45-32.26-17.05-.17-.38-.24-.79-.24-1.21V28.33c0-10.93 8.86-19.79 19.79-19.79h12.71"
                style={{ fill: "#c98254" }}
              />
              <path
                d="M48.98 8.55h12.71c10.93 0 19.79 8.86 19.79 19.79v27.67c0 .59-.15 1.17-.47 1.66-5.21 8.04-18.91 16.54-32.03 16.87"
                style={{ fill: "#b46a39" }}
              />

              {/* L EyePatch/R EyePatch */}
              <path
                d="M25 25.12h16.88v18.53H26.47c-5.52 0-10-4.48-10-10 0-4.71 3.82-8.53 8.53-8.53Z"
                style={{ fill: "#9b5623", opacity: 0.5 }}
                transform="rotate(-180 29.18 34.38)"
              />
              <path
                d="M65.32 25.12H81.2c.15 0 .26.12.26.26v18c0 .15-.12.26-.26.26H65.32c-5.11 0-9.26-4.15-9.26-9.26 0-5.11 4.15-9.26 9.26-9.26Z"
                style={{ opacity: 0.5, fill: "#602c06" }}
              />
